            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@healthblog.com</p>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-primary-blue/10 rounded-full flex items-center justify-center hover:bg-primary-blue hover:text-white transition-colors">
          ...
          <div>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-primary-blue text-white py-3 px-6 rounded-lg hover:bg-blue-600 transition-colors"
                >
                  Send Message
                </button>
              </div>
